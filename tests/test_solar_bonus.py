...
async def test_solar_bonus_is_daylight_edge_cases(hass: HomeAssistant):
    ...
    with patch('custom_components.dynamic_energy_contract_calculator.solar_bonus.datetime') as mock_dt:
...
async def test_solar_bonus_contract_year_calculation(hass: HomeAssistant):
    ...
    with patch('custom_components.dynamic_energy_contract_calculator.solar_bonus.datetime', MockDateTime):
...
async def test_solar_bonus_auto_reset_on_new_contract_year(hass: HomeAssistant):
    ...
    with patch('custom_components.dynamic_energy_contract_calculator.solar_bonus.datetime', MockDateTime2024):
        tracker = await SolarBonusTracker.async_create(
    ...
    with patch('custom_components.dynamic_energy_contract_calculator.solar_bonus.datetime', MockDateTime2025):
